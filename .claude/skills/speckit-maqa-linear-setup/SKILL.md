---
name: speckit-maqa-linear-setup
description: Bootstrap Linear config for MAQA. Lists your teams and workflow states
  via the Linear GraphQL API and generates maqa-linear/linear-config.yml. Run once
  per project.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: maqa-linear:commands/speckit.maqa-linear.setup.md
---
