...
- [X] T025 [US2] Re-run the same workflow via `workflow_dispatch`; verify it reports "No pending migrations." and does not double-apply (FR-008; fixture T3; US2 acceptance scenario 4)
