...
**Purpose**: Cross-cutting infrastructure every user story depends on: logger, error classes, axios HTTP wrapper, pagination helper, federation seam, import-boundary guard, shared schemas.
