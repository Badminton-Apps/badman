      ...
      describe('valid', () => {
        ...
        test.each(valid)('Single %p is better then Single %p', async (p1, p2) => {
          ...
          const error = validation.errors?.find(
            (e) => e.message === 'all.teamFormation.errors.player-order-single',
          );
        ...
        test.each(valid)('Double %p is  better then Double %p', async (p1, p2) => {
          ...
          const error = validation.errors?.find(
            (e) => e.message === 'all.teamFormation.errors.player-order-doubles',
          );
          expect(error).toBeUndefined();
        });
        ...
        test.each(valid)('Double %p is not better then Double %p by level', async (p1, p2) => {
          ...
          const error = validation.errors?.find(
            (e) => e.message === 'all.teamFormation.errors.player-order-highest',
          );
          expect(error).toBeUndefined();
        });
      });
    ...
    describe('Rule [TeamSubeventIndexRule]', () => {
      ...
      describe('valid', () => {
        it('should be valid', async () => {
          ...
          const error = validation.errors?.find(
            (e) => e.message === 'all.teamFormation.errors.team-to-strong',
          );
          expect(error).toBeUndefined();
        });
      });
    ...
    describe('Rule [PlayerCompStatusRule]', () => {
      ...
      describe('valid', () => {
        it('should be valid', async () => {
          ...
          const error = validation.errors?.find(
            (e) => e.message === 'all.teamFormation.errors.comp-status-html',
          );
          expect(error).toBeUndefined();
        });
      });
    ...
    describe('Rule [PlayerMaxGamesRule]', () => {
      ...
      describe('valid', () => {
        it('should be valid single', async () => {
          ...
          const error = validation.errors?.find(
            (e) => e.message === 'all.teamFormation.errors.player-max-single-games',
          );
          expect(error).toBeUndefined();
        });
        ...
        it('should be valid double', async () => {
          ...
          const error = validation.errors?.find(
            (e) => e.message === 'all.teamFormation.errors.player-max-double-games',
          );
          expect(error).toBeUndefined();
        });
      });
    ...
    describe('Rule [PlayerGenderRule]', () => {
      ...
      describe('valid', () => {
        it('should be valid single', async () => {
          ...
          const error = validation.errors?.find(
            (e) =>
              e.message === 'all.teamFormation.errors.player-genders' ||
              e.message === 'all.teamFormation.errors.player-gender',
          );
          expect(error).toBeUndefined();
        });
      });
      ...
      describe('invalid', () => {
        ...
        test.each(games)('should be invalid single if the player the wrong gender', async (g) => {
          ...
          const error = validation.errors?.find(
            (e) => e.message === 'all.teamFormation.errors.player-gender',
    ...
    describe('Rule [PlayerMaxGamesRule]', () => {
      ...
      describe('invalid', () => {
        it('should be invalid if the player has more then 1 mixed', async () => {
          ...
          const error = validation.errors?.find(
            (e) => e.message === 'all.teamFormation.errors.player-max-mix-games',
          ) as AssemblyValidationError<PlayerMaxGamesRuleParams>;
    ...
    describe('Rule [PlayerGenderRule]', () => {
      ...
      describe('invalid', () => {
        it('should be invalid if a mixed 3 has 2 of the same gender', async () => {
          ...
          const error = validation.errors?.find(
            (e) => e.message === 'all.teamFormation.errors.player-genders',
    ...
    describe('Rule [PlayerMinLevelRule]', () => {
      ...
      describe('valid', () => {
        it('should be valid', async () => {
          ...
          const error = validation.errors?.find(
            (e) => e.message === 'all.teamFormation.errors.player-min-level',
          );
          expect(error).toBeUndefined();
        });
    ...
    describe('Rule [TeamBaseIndexRule]', () => {
      ...
      describe('valid', () => {
        it('First team is allowed to have higher team index then base', async () => {
          ...
          const error = validation.errors?.find(
            (e) => e.message === 'all.teamFormation.errors.team-index',
          );
          expect(error).toBeUndefined();
        });
    ...
    describe('Rule [TeamClubBaseRule]', () => {
      ...
      describe('invalid', () => {
        it('Second team not', async () => {
          ...
          const error = validation.errors?.find(
            (e) => e.message === 'all.teamFormation.errors.club-base-other-team',
