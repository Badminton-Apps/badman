...
export class PlayerOrderRule extends Rule {
  ...
  private _checkSingle(
    ...
    if (ranking2 < ranking1) {
      return {
        message: 'all.teamFormation.errors.player-order-single',
        params: {
          game1,
          game2,
          player1: {
  ...
  private _checkDouble(
    ...
    if (d2p1 + d2p2 < d1p1 + d1p2) {
      return {
        message: 'all.teamFormation.errors.player-order-doubles',
        params: {
          game1,
          game2,
          team1player1: {
      ...
      if (highestd2 < highestd1) {
        return {
          message: 'all.teamFormation.errors.player-order-highest',
          params: {
            game1,
            game2,
            team1player1: {
