...
<<<<<<< HEAD:libs/backend/competition/enrollment/src/services/validate/validation.service.spec.ts
...
describe.skip('EnrollmentService', () => {
  ...
  let subEvent: SubEventCompetition;
  let encounter: EncounterCompetition;
>>>>>>> develop:libs/backend/competition/enrollment/src/services/validate/enrollment.service.spec.ts
