...
describe('EnrollmentValidationService', () => {
  ...
  //             (e) =>
  //               e.message ===
  //               'all.teamFormation.errors.player-order-single'
  //           );
  ...
  //             (e) =>
  //               e.message ===
  //               'all.teamFormation.errors.player-order-doubles'
  //           );
  //           expect(error).toBeUndefined();
  //         }
  //       );
  ...
  //             (e) =>
  //               e.message ===
  //               'all.teamFormation.errors.player-order-highest'
  //           );
  //           expect(error).toBeUndefined();
  //         }
  //       );
  ...
  //           (e) =>
  //             e.message ===
  //             'all.teamFormation.errors.team-to-strong'
  //         );
  //         expect(error).toBeUndefined();
  //       });
  //     });
  ...
  //         const error = validation.errors?.find(
  //           (e) =>
  //             e.message === 'all.teamFormation.errors.comp-status-html'
  //         );
  //         expect(error).toBeUndefined();
  //       });
  //     });
  ...
  //           (e) =>
  //             e.message ===
  //             'all.teamFormation.errors.player-max-single-games'
  //         );
  //         expect(error).toBeUndefined();
  //       });
  ...
  //           (e) =>
  //             e.message ===
  //             'all.teamFormation.errors.player-max-double-games'
  //         );
  //         expect(error).toBeUndefined();
  //       });
  //     });
  ...
  //           (e) =>
  //             e.message ===
  //               'all.teamFormation.errors.player-genders' ||
  ...
  //             (e) =>
  //               e.message ===
  //               'all.teamFormation.errors.player-gender'
  //           );
  ...
  //           (e) =>
  //             e.message ===
  //             'all.teamFormation.errors.player-max-mix-games'
  //         );
  ...
  //           (e) =>
  //             e.message ===
  //             'all.teamFormation.errors.player-min-level'
  //         );
  //         expect(error).toBeUndefined();
  //       });
  //     });
  ...
  //         const error = validation.errors?.find(
  //           (e) =>
  //             e.message === 'all.teamFormation.errors.team-index'
  //         );
  //         expect(error).toBeUndefined();
  //       });
  ...
  //           (e) =>
  //             e.message ===
  //             'all.teamFormation.errors.club-base-other-team'
  //         );
