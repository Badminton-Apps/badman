  ...
  async getTeamAssemblyPdf() {
    ...
    const doubles = [
      this.add_player(
        ...
        based,
        teamed,
        '23ceec83-6b4f-4525-9db5-4e77f3876570',
        'c2140fa9-6ea6-4a41-9c7d-c7d27aed14bd'
      ),
      this.add_player(
        preppedMap,
        based,
        teamed,
        'c2140fa9-6ea6-4a41-9c7d-c7d27aed14bd',
        'e8168502-8fdd-4584-9f82-28ae21b55d33'
      ),
      this.add_player(
        preppedMap,
        based,
        teamed,
        '38ae9f3a-95cd-48f6-a101-84fdc8a59924',
        'e8168502-8fdd-4584-9f82-28ae21b55d33'
      ),
      this.add_player(
        preppedMap,
        ...
        teamed,
        'e8168502-8fdd-4584-9f82-28ae21b55d33',
        '90fcc155-3952-4f58-85af-f90794165c89'
      )
    ];
    ...
    const singles = [
      ...
      this.add_player(
        ...
        based,
        teamed,
        '06def4fc-6442-4646-a017-f11d7d61eeaf'
      ).player1,
      this.add_player(
        preppedMap,
        based,
    ...
    let pdf = await this._htmlToPdf(
      'assembly',
      {
        ...
        captain: players.find(p => p.id == captainId)?.fullName,
        doubles: doubles,
        singles: singles,
        subtitudes: [
          this.add_player(
            ...
            based,
            teamed,
            '5af81423-acfb-4f2a-9aa6-13b47d296d83'
          ).player1,
          this.add_player(
            preppedMap,
            based,
            teamed,
            'def9c355-4625-4499-83a3-4ceb8a2ca6cd'
          ).player1
        ],
        type: type
      },
