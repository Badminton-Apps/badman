...
// // jest.mock('@badvlasim/shared/models/sequelize/system.model.ts');

// describe.skip('bvl', () => {
//   let mockDatabaseService: MockObj<DataBaseHandler>;
//   let system: RankingSystem;

//   describe.skip('BV 80 20 15', () => {
...
//       });
//       service = new BvlRankingCalc(system, mockDatabaseService as DataBaseHandler, false);
//     });

//     test('Test point caps', () => {
//       expect(system.pointsToGoUp).toStrictEqual([
//         40, // to 11
//         64, // to 10
//         102.4, // to 9
//         163.84, // to 8
...
//         4398.046511103999
//       ]);
//       expect(system.pointsToGoDown).toStrictEqual([
//         16,
//         25.6,
//         40.96,
//         65.536,
...
//         1759.2186044415998
//       ]);
//       expect(system.pointsWhenWinningAgainst).toStrictEqual([
//         50,
//         80,
//         128,
//         204.8,
