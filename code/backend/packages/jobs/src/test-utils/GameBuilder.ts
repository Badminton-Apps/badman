import { DrawTournament, EncounterCompetition, Game, GamePlayer, GameType } from '@badvlasim/shared';
...
export class GameBuilder {
  ...
  WithSet(team1Score: number, team2Score: number): GameBuilder {
    this.game[`set${this.set}Team1`] = team1Score;
    this.game[`set${this.set}Team2`] = team2Score;
    this.set++;
