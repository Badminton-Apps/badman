import { Event, SubEvent } from '@badvlasim/shared';
import {
  GraphQLEnumType,
...
import { SubEventInputType, SubEventType } from './subEvent.type';
...
export const EventInputType = new GraphQLInputObjectType({
  ...
  fields: () =>
    Object.assign(getAttributeFields(Event, true), {
      subEvents: {
        type: new GraphQLList(SubEventInputType)
      }
    })
});
