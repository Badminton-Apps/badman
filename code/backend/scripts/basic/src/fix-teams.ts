...
(async () => {
  ...
  async function fixTeams() {
    ...
    // Division 1
    const membership0 = new EventEntry({
    ...
    const membership1 = new EventEntry({
    ...
    const membership2 = new EventEntry({
    ...
    const membership3 = new EventEntry({
    ...
    const membership4 = new EventEntry({
    ...
    const membership5 = new EventEntry({
    ...
    const membership6 = new EventEntry({
    ...
    // Division 2
    // Verviers
    const membership7 = new EventEntry({
    ...
    // Dijevallei
    const membership8 = new EventEntry({
    ...
    // Grace
    const membership9 = new EventEntry({
    ...
    // Antwerp
    const membership10 = new EventEntry({
    ...
    // Hebvad
    const membership11 = new EventEntry({
    ...
    // Olve
    const membership12 = new EventEntry({
    ...
    // Nivelles
    const membership13 = new EventEntry({
    ...
    // Nivelles
    const membership14 = new EventEntry({
