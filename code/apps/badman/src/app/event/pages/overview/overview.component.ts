  ...
  ngOnInit() {
    ...
    this.formGroup = new FormGroup({
      ...
      startYear: new FormControl(
        parseInt(queryParams['year'], 10) ?? undefined,
        [Validators.pattern('^[0-9]*$')]
      ),
      type: new FormControl(queryParams['type'] ?? EventType.COMPETITION_CP, [
        Validators.required,
      ]),
      allowEnlisting: new FormControl(
        queryParams['allowEnlisting'] === undefined
          ? undefined
          : queryParams['allowEnlisting'] === 'true'
      ),
      started: new FormControl(
        queryParams['started'] === undefined
          ? undefined
    ...
    combineLatest([
      ...
      .pipe(
        ...
        map(([filterChange]) => {
          ...
          if (
            filterChange.started != undefined &&
            filterChange.type == EventType.COMPETITION_CP
          ) {
