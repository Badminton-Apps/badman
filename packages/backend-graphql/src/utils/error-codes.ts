...
export const ErrorCode = {
  ...
  // Enrollment (packages/backend-graphql/src/resolvers/event/competition/enrollment.resolver.ts)
  TEAM_NOT_FOUND: "TEAM_NOT_FOUND",
  SUB_EVENT_NOT_FOUND: "SUB_EVENT_NOT_FOUND",
  SEASON_MISMATCH: "SEASON_MISMATCH",

  // Team (packages/backend-graphql/src/resolvers/team/team.resolver.ts)
  CLUB_NOT_FOUND: "CLUB_NOT_FOUND",
  PLAYER_NOT_FOUND: "PLAYER_NOT_FOUND",
  RANKING_NOT_FOUND: "RANKING_NOT_FOUND",

  // Club membership (packages/backend-graphql/src/resolvers/club/club.resolver.ts)
  MEMBERSHIP_NOT_FOUND: "MEMBERSHIP_NOT_FOUND",

  // Index calculation (packages/backend-graphql/src/resolvers/event/competition/calculate-index/calculate-index.resolver.ts)
  RANKING_SYSTEM_NOT_FOUND: "RANKING_SYSTEM_NOT_FOUND",

  // Event entry finalisation (packages/backend-graphql/src/resolvers/event/entry.resolver.ts)
