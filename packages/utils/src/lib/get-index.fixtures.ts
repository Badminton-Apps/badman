...
export const INDEX_CALCULATION_FIXTURES: IndexCalculationFixture[] = [
  ...
  },
  {
    ...
    type: SubEventTypeEnum.M,
    players: [m(4, 4), m(4, 4), m(4, 4), m(4, 4), m(11, 11), m(11, 11), m(11, 11), m(11, 11)],
    expected: 32,
  },
  {
  ...
  },
  {
    ...
    type: SubEventTypeEnum.MX,
    players: [m(8, 8, 8), m(8, 8, 8), m(8, 8, 8), m(8, 8, 8), f(8, 8, 8)],
    expected: 108,
  },
  ...
  // missing components — default fill
  {
    ...
    type: SubEventTypeEnum.M,
    players: [m(8, undefined), m(8, undefined), m(8, undefined), m(8, undefined)],
    expected: 80,
  },
  {
    name: "M: each player has only `double=8` → (12+8) × 4 = 80",
    type: SubEventTypeEnum.M,
    players: [m(undefined, 8), m(undefined, 8), m(undefined, 8), m(undefined, 8)],
    expected: 80,
  },
  {
    name: "MX: 2M+2F with `mix` undefined → (8+8+12) × 4 = 112",
    type: SubEventTypeEnum.MX,
    players: [m(8, 8, undefined), m(8, 8, undefined), f(8, 8, undefined), f(8, 8, undefined)],
    expected: 112,
  },
  {
  ...
  },
  {
    ...
    type: SubEventTypeEnum.MX,
    players: [m(2, 2, 2), m(2, 2, 2), m(10, 10, 10), m(10, 10, 10), f(5, 5, 5), f(5, 5, 5)],
    expected: 42,
  },
  ...
  },
  {
    ...
    type: SubEventTypeEnum.MX,
    players: [m(7, 8, 8), m(8, 7, 9), m(9, 6, 7), f(6, 9, 8), f(10, 10, 10)],
    expected: 98,
  },
];
