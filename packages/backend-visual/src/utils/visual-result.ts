 ...
 */
const requiredCoercedString = z.union([z.string(), z.number()]).transform((v) => String(v));
...
export const XmlTournamentEventSchema = z
  .object({
    ...
    SubGrading: z.preprocess(
      dropPrimitive("TournamentEvent.SubGrading"),
      XmlGradingSchema.optional()
    ),
  })
  .passthrough();
...
export const XmlTournamentSchema = z
  .object({
    ...
    Organization: z.preprocess(
      dropPrimitive("Tournament.Organization"),
      XmlOrganizationSchema.optional()
    ),
