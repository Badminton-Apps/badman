...
import {
  ...
  DrawCompetitionProcessor,
  DrawCompetitionScheduler,
  EncounterCompetitionProcessor,
  EncounterCompetitionScheduler,
  GameCompetitionProcessor,
  MatchCompetitionScheduler,
  SubEventCompetitionProcessor,
  SubEventCompetitionScheduler,
  EventCompetitionProcessor,
  StandingCompetitionProcessor,
  EventCompetitionScheduler,
} from './processors';
